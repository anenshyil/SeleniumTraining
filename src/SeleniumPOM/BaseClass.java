...
public class BaseClass {
	...
	public static String Isdisplayingcheck(WebElement element,String value) {
		
		if(element.isDisplayed()==true)
			System.out.println(value+" is present");
		else
			System.out.println(value+" is not presesnt");
		return value;
	}
	
	public static String IsSelectedcheck(WebElement element,String value) {
	...
	public static void scrollByPixel(int val1,int val2) {
		...
		JavascriptExecutor js=(JavascriptExecutor) driver;
		js.executeScript("(window.scrollBy("+val1+","+val2+"))");
	...
	public static String phoneNoCheck(WebElement element) {
		...
		{
			System.out.println(phno+" Valid mobile number");
		}
		else
		{
	...
	public static String getAttrib(WebElement element) {
					String val = element.getAttribute("value");//("value");
					System.out.println(val);
					return val;
	}
